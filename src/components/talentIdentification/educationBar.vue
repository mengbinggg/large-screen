 ...
 * @LastEditTime: 2024-01-03 15:57:10
 * @FilePath: /large-screen/src/components/talentIdentification/educationBar.vue
 * @Description: 学历分布
-->
<template>
...
export default {
  ...
  methods: {
    initChart() {
      this.myChart = echarts.init(document.getElementById('education'))
        ...
        series: [
          {
            ...
            type: "pictorialBar",
            zlevel: 2,
            symbol: 'image://' + require('../../assets/talent/bar_bg.png'),
            symbolOffset: [0, -1],
            symbolRepeat: "fixed",
            symbolClip: true,
